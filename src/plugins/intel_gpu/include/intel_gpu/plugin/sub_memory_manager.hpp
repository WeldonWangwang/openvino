...
public:
    ...
    struct MemoryInfo {
        ...
        std::vector<bool> all_reduce_copy_flag;
        std::vector<bool> all_reduce_concat_flag;
        std::vector<bool> all_reduce_concat_flag2;
        std::vector<bool> all_reduce_add_flag;
    ...
    SubMemoryManager(int num_sub_streams) {
        ...
        memory_info.all_gather_read_flag = false;
        ...
        memory_info.all_reduce_copy_flag.assign(_num_sub_streams, false);
        memory_info.all_reduce_concat_flag.assign(_num_sub_streams, false);
        memory_info.all_reduce_concat_flag2.assign(_num_sub_streams, false);
        memory_info.all_reduce_add_flag.assign(_num_sub_streams, false);
