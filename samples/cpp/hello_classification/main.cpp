...
void create_test_model() {
    ...
    auto model = std::make_shared<ov::Model>(ov::ResultVector{result}, ov::ParameterVector{param, param1});
    ov::serialize(model, "ww_329.xml");
}
/**
...
int tmain(int argc, tchar* argv[]) {
    try {
        ...
        ov::CompiledModel compiled_model = core.compile_model(model, device_name, {{"MODEL_DISTRIBUTION_POLICY", "PIPELINE_PARALLEL"}});
